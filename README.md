...
![Funnel Chart](./Tableau_visualizations/Ecom_funnel_conversion.png)

## Revenue Analysis
- Daily revenue trends:

![Daily Revenue](./Tableau_visualizations/Daily_revenue_trend.png)

- Top users by revenue:

![Top Users](./Tableau_visualizations/Top_10_users_by_revenue.png)

- Revenue by new vs returning users:

![Revenue by User Type](./Tableau_visualizations/New_vs_returning_users_revenue.png)
